...
{
    return [self stringWithFormat:format useGMT:NO];
}
...
- (NSData *)base64StringToData
{
	...
	size_t outputLength;
	void *outputBuffer = LNewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)base64EncodedString
{
    ...
    char *outputBuffer = LNewBase64Encode([self bytes], [self length], false, &outputLength);
